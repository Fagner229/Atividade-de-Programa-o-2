...
exports.onRenderTriggered = exports.onRenderTracked = exports.onMounted = exports.onErrorCaptured = exports.onDeactivated = exports.onBeforeUpdate = exports.onBeforeUnmount = exports.onBeforeMount = exports.onActivated = void 0;
...
},{}],"components/Contatos.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    adicionarContato: function adicionarContato() {
    ...
    excluirContato: function excluirContato(index) {
      this.contatos.splice(index, 1);
    },
    editarContato: function editarContato(index) {
      this.index = index;
  ...
  computed: {
    numContatos: function numContatos() {
      return this.contatos.length;
    }
  },
  watch: {
    contatos: function contatos(val) {
      console.log('val', val);
    }
  }
};
exports.default = _default;
        var $a6f4bc = exports.default || module.exports;
      
      if (typeof $a6f4bc === 'function') {
        $a6f4bc = $a6f4bc.options;
      }
    
        /* template */
        Object.assign($a6f4bc, (function () {
          var render = function () {
  var _vm = this
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      [
        _c("div", { staticClass: "form-contato form-group" }, [
          _c("p", [
            _c("input", {
              directives: [
                {
              ...
              attrs: { placeholder: "Nome", type: "text", name: "nome" },
          ...
          _c("p", [
            _c("input", {
              ...
              staticClass: "form-control",
              attrs: { placeholder: "Telefone", name: "telefone" },
      ...
      _c(
        ...
        [
          _vm.numContatos <= 0
            ? _c("p", [_vm._v("Adicione um contato na agenda...")])
            : _c("p", [
                _vm._v(
                  "Há " + _vm._s(_vm.numContatos) + " contatos na agenda."
                ),
              ]),
          _vm._v(" "),
          _vm._l(_vm.contatos, function (contato, index) {
            return _c("div", { key: index, staticClass: "list-group-item" }, [
              _c("span", { staticClass: "nome_class" }, [
                _vm._v("Nome: "),
                _c("strong", [_vm._v(_vm._s(contato.nome))]),
              ]),
              _vm._v(" "),
              _c("p", [
                _c("span", { staticClass: "telefone_class" }, [
                  _vm._v("\n          Telefone: "),
                  _c("strong", [_vm._v(_vm._s(contato.telefone))]),
                ]),
              ]),
              _vm._v(" "),
              _c("div", [
                _c(
                  "a",
                  {
                    attrs: { href: "#", title: "Excluir" },
                    on: {
                      click: function ($event) {
                        $event.preventDefault()
                        return _vm.excluirContato(index)
                      },
                    },
                  },
                  [_vm._v("\n          Excluir\n        ")]
                ...
                _c(
                  "a",
                  {
                    ...
                    on: {
                      click: function ($event) {
                        $event.preventDefault()
                        return _vm.editarContato(index)
                      },
                    },
                  },
                  [_vm._v("\n          Editar\n        ")]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$a6f4bc', $a6f4bc);
          } else {
            api.reload('$a6f4bc', $a6f4bc);
          }
        }
...
var _Contatos = _interopRequireDefault(require("./components/Contatos"));
...
var _default = {
  name: 'app',
  components: {
    Contatos: _Contatos.default
  }
};
exports.default = _default;
        var $8f5a70 = exports.default || module.exports;
      
      if (typeof $8f5a70 === 'function') {
        $8f5a70 = $8f5a70.options;
      }
    
        /* template */
        Object.assign($8f5a70, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$8f5a70', $8f5a70);
          } else {
            api.reload('$8f5a70', $8f5a70);
          }
        }
...
},{"./components/Contatos":"components/Contatos.vue","_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=/vue-parcel.e31bb0bc.js.map